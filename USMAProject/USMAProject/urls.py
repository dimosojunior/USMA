...
schema_view = get_schema_view(
    openapi.Info(
        title="UNIVERSITY STUDENTS MATERIALS APP",
        default_version='v1',
        description="A Rest API for UNIVERSITY STUDENTS MATERIALS App",
